...
def start_embeddings():
    try:
        ...
        if not contents:
            raise HTTPException(status_code=404, detail="No files to embed.")
        ...
        for obj in contents:
            ...
            lambda_client.invoke(
                FunctionName=os.getenv("EMBEDDING_LAMBDA_NAME"),
        ...
        traceback.print_exc()
        raise HTTPException(status_code=500, detail=f"Embedding trigger failed: {str(e)}")
